...
const navItems = [
  ...
  { to: '/peta', label: 'Peta Interaktif', icon: MapPinned },
  { to: '/monitoring', label: 'Monitoring Kualitas Air', icon: Activity },
  { to: '/mitigasi', label: 'Mitigasi Cerdas', icon: Wrench },
  { to: '/laporan', label: 'Laporan Warga', icon: ClipboardList },
  { to: '/peringatan', label: 'Pusat Peringatan', icon: BellRing },
  { to: '/chatbot', label: 'AquaVoice Chatbot', icon: Bot },
]
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between px-6 h-20 border-b border-abyss-800">
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              ...
              <p className="text-[11px] text-abyss-400 text-mist-100/50">
        ...
        <div className="p-4 mx-4 mb-5 rounded-2xl bg-abyss-900 border border-abyss-800">
          <p className="text-xs font-semibold text-current-300">Status Jaringan Sensor</p>
          <p className="mt-1 text-[13px] text-mist-100/60">
            48 dari 52 node IoT aktif dan mengirim data secara real-time.
          </p>
        </div>
      </aside>
    </>
