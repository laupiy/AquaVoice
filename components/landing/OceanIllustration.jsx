...
export default function OceanIllustration() {
  return (
    <div className="relative w-full h-[300px] xl:h-[340px] rounded-3xl overflow-hidden border border-white/10 bg-gradient-to-br from-abyss-900 via-abyss-900 to-current-600/20">
      ...
      <svg className="absolute -bottom-1 left-0 w-full animate-wave-a" viewBox="0 0 500 100" preserveAspectRatio="none">
        <path d="M0,55 C90,85 160,25 250,50 C340,75 410,30 500,55 L500,100 L0,100 Z" fill="#14B8A6" fillOpacity="0.28" />
      </svg>
      <svg className="absolute -bottom-1 left-0 w-full animate-wave-b" viewBox="0 0 500 100" preserveAspectRatio="none">
        <path d="M0,70 C100,40 180,90 280,65 C370,42 430,80 500,60 L500,100 L0,100 Z" fill="#0EA5E9" fillOpacity="0.22" />
      </svg>
    </div>
  );
}
